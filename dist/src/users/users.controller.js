...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get current user profile with recent orders' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Paginated list of all users' }),
